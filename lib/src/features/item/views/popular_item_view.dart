...
class PopularItemView extends ConsumerStatefulWidget {
  const PopularItemView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _PopularItemViewState();
}

class _PopularItemViewState extends ConsumerState<PopularItemView> {
